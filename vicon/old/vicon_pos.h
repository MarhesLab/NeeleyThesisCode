...
#define VSLEEP 10
//#define VICONIP  "192.168.0.112:801"
...
//class vicon_pos: public virtual gps {
class vicon_pos {
	//vicon client class
...
//PFG
	void ViconConnect(const char *VICONIP);
...
//
	 ...
	 */
	void get_subject_coord(int,float&,float&,float&);
...
//WJN
	int getTimeStampValues(unsigned int&, unsigned int&, unsigned int& );
	double getLatencyTotal();
};
